package com.jachs.netty.spdy.server;
 ...
 * OpenJDK versions. See <a href=
 * "https://www.eclipse.org/jetty/documentation/current/npn-chapter.html">Jetty
 * docs</a> for more information.
 * <p>
 * You may also use the {@code run-example.sh} script to start the server from
 * the command line:
 * 
 * <pre>
 ...
 * <a href="https://en.wikipedia.org/wiki/SPDY#Browser_support_and_usage">SPDY
